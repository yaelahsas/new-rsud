        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-header text-uppercase text-muted" style="font-size: 0.75rem; letter-spacing: 0.05em;">
                    ...
                    <!-- Galeri -->
                    <li class="nav-item">
                        <a wire:navigate href="{{ route('admin.galeri') }}"
                    ...
                    <li class="nav-item">
                        <a wire:navigate href="{{ route('admin.inovasi') }}"
                            class="nav-link {{ request()->is('admin/inovasi') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a wire:navigate href="{{ route('admin.pengumuman') }}"
                    ...
                    <li class="nav-item">
                        <a wire:navigate href="{{ route('admin.kontak') }}"
                    ...
                    <li class="nav-item">
                        <a wire:navigate href="{{ route('admin.log-aktivitas') }}"
                    ...
                    <li class="nav-item">
                        <a wire:navigate href="{{ route('admin.review') }}"
